...
export default new (class BangumisView extends AbstractView
{
    ...
    openBangumi(): void
    {
        ...
        getAllBangumi(this._bangumiUrl.setPage(this._pageNumber)).then(
            (data: BangumisData | undefined) => this.createBangumiView(data)
        );
    }
